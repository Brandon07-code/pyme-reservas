...
@section('content')
    ...
    <form method="GET" action="{{ route('clientes.index') }}" class="mb-6 flex gap-2">
        ...
        @if($search) <a href="{{ route('clientes.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded shadow text-xs uppercase tracking-wider transition">Limpiar</a> @endif
    </form>
