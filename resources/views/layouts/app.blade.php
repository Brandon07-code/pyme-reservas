...
<body class="bg-gray-100 font-sans leading-normal tracking-normal text-gray-800">
    ...
    <script>
        ...
        @auth
        // Sondeo en tiempo real para notificaciones (AJAX Polling)
        function checkNotifications() {
            ...
            .then(data => {
                ...
                if (badge && lista) {
                    ...
                    if (data.count > 0) {
                        // Si hay nuevas notificaciones (el número aumentó), podríamos reproducir un sonido
                        if (parseInt(badge.textContent || 0) < data.count && !badge.classList.contains('hidden')) {
                    ...
                    // Actualizar el HTML del menú desplegable
