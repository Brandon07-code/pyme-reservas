                ...
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center text-sm font-semibold">
                    ...
                    <li class="mr-3">
                        <a href="{{ route('portal.cart.index') }}" class="relative inline-block py-2 px-2 text-gray-400 hover:text-[#D4AF37] transition">
                            ...
                            @if($cartCount > 0)
                                <span class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-[10px] font-bold leading-none text-black bg-[#D4AF37] rounded-full transform translate-x-1/2 -translate-y-1/2">
                                    {{ $cartCount }}
                                </span>
                            @endif
                        </a>
