...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow-md rounded-lg p-8 mb-6">
            ...
            <p><strong>Fecha y Hora:</strong> {{ \Carbon\Carbon::parse($reserva->fecha)->format('d/m/Y') }} a las {{ \Carbon\Carbon::parse($reserva->hora_inicio)->format('h:i A') }}</p>
        ...
        <form action="{{ route('reservas.update', $reserva) }}" method="POST" class="bg-white shadow-md rounded-lg p-8">
            ...
            @php
                ...
                $fechaHoraFin = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $fechaFmt . ' ' . $reserva->hora_fin);
