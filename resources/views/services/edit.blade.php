        ...
        <form action="{{ route('servicios.update', $servicio) }}" method="POST" class="bg-white shadow-md rounded-lg p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $servicio->nombre) }}" required class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border p-2">
                ...
                <div>
                    ...
                    <select name="service_category_id" id="service_category_id" required class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border p-2 bg-white">
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->id }}" {{ old('service_category_id', $servicio->service_category_id) == $cat->id ? 'selected' : '' }}>
                                {{ $cat->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" step="100" name="precio" id="precio" value="{{ old('precio', $servicio->precio) }}" required class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border p-2">
                ...
                <div>
                    ...
                    <input type="number" name="duracion_minutos" id="duracion_minutos" value="{{ old('duracion_minutos', $servicio->duracion_minutos) }}" required class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border p-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border p-2">{{ old('descripcion', $servicio->descripcion) }}</textarea>
